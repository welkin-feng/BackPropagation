...
class BP:
    ...
    def train(self, mu_out, sigma_out, time = 1000, print_state = False):
...
def main():
    ...
    bp.train(mu_out, sigma_out, time = 1000, print_state = False)
...
def demo():
    ...
    bp = BP(input_examples_values = l_in_nor[:train_num], output_examples_values = l_out_nor[:train_num], hiding_nodes_number = 8)
